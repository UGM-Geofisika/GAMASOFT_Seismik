...
namespace Unplugged.IbmBits
{
    public static class IbmConverter
    {
        ...
        static readonly Encoding Ebcdic = Encoding.GetEncoding("IBM037");
        ...
        private const int IbmBase = 16;
        private const byte ExponentBias = 64;
        private const int ThreeByteShift = 16777216;
        ...
        public static Single ToSingle(byte[] value)
        {
            ...
            var fraction = mantissa / (float)ThreeByteShift;
        ...
        public static byte[] GetBytes(Single value)
        {
            ...
            var moveRadix = (int)Math.Log(v, IbmBase) + 1;
            var fraction = v / (Math.Pow(IbmBase, moveRadix));
            var fractionInt = (int)(ThreeByteShift * fraction);
            ...
            // Exponent
            var exponent = moveRadix + ExponentBias;
